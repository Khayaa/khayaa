...
**Made with : Php (Laravel) ,Livewire, Alpine Js , Bootstrap ,MySQL , Rest-Api  & deployed using Laravel Forge .**
  ...
  - ( [Amile Amazulu Foundation](https://drwilsondentalcare.com/) , [Uniqualify User & Admin Authentication System ](https://uniqualify.co.za) , [Studentn Registration  System Demo ](https://lms-demo.uniqualify.co.za/)) 
